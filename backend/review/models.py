...
class Lodgement_Review(models.Model):
    ...
    communication_grade = models.IntegerField(
        choices=RATING_CHOICES, null=False, default=5
    )
    localization_grade = models.IntegerField(
        choices=RATING_CHOICES, null=False, default=5
    )
    quality_price_ratio_grade = models.IntegerField(
        choices=RATING_CHOICES, null=False, default=5
    )
    ...
    def average_grade(self):
        grades = [
            self.cleaning_grade,
            self.communication_grade,
            self.localization_grade,
            self.quality_price_ratio_grade,
        ]
